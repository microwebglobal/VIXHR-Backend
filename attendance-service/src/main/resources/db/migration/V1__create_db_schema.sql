...
CREATE TABLE overtime_clock_event
(
    id                    BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    created_at            TIMESTAMP WITHOUT TIME ZONE,
    updated_at            TIMESTAMP WITHOUT TIME ZONE,
    ...
    notes                 VARCHAR(500),
    CONSTRAINT pk_overtimeclockevent PRIMARY KEY (id)
);

ALTER TABLE attendance_records
    ADD CONSTRAINT uc_2d59693229e685c17daefd1b2 UNIQUE (employee_id, date);

ALTER TABLE overtime_clock_event
    ADD CONSTRAINT FK_OVERTIMECLOCKEVENT_ON_GEO_FENCE_LOCATION FOREIGN KEY (geo_fence_location_id) REFERENCES geofence_locations (id);